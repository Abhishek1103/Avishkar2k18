...
public class RSA {
    ...
    public void savePublicKey(String filename) throws NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        try {
            saveKeys(Constants.USER_DIR + "keys/" + filename, rsaPublicKeySpec.getModulus(), rsaPublicKeySpec.getPublicExponent());
        }catch(Exception e){
            e.printStackTrace();
        }
    }
    ...
    public void savePrivateKey(String filename) throws InvalidKeySpecException, NoSuchAlgorithmException {
        ...
        try {
            saveKeys(Constants.USER_DIR + "keys/" + filename, rsaPrivateKeySpec.getModulus(), rsaPrivateKeySpec.getPrivateExponent());
        }catch(Exception e){
            e.printStackTrace();
        }
    }
